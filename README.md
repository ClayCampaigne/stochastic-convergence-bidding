...
The key insight is that we can simultaneously **optimize both bid prices and quantities** for electricity market bids in a fully general stochastic optimization via a **linear program** by:
